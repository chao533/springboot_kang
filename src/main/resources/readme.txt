...
docker run -d --name storage --net=host -e TRACKER_IP=192.168.1.129:22122 -e GROUP_NAME=group1 morunchang/fastdfs sh storage.sh

-- xxl_job
docker pull xuxueli/xxl-job-admin:2.0.1
docker run -e PARAMS="--spring.datasource.url=jdbc:mysql://192.168.1.129:3306/xxl_job?useUnicode=true&characterEncoding=UTF-8 --spring.datasource.password=123456" -p 8181:8080 -v /xxl-job-log:/data/applogs --name xxl-job-admin -d xuxueli/xxl-job-admin:2.0.1
